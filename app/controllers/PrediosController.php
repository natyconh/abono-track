<?php
/**
 * Controlador para la Administración de Predios
 * MODIFICADO: Filtra cabezales en el index y asegura guardado de tipos.
 */
class PrediosController extends Controller {
    ...
    public function index() {
        $data = [
            'titulo' => 'Administración de Predios',
            // CAMBIO CLAVE: Usamos obtenerPrediosAgricolas para filtrar cabezales
    ...
    public function guardar() {
        ...
        if ($datos['umbral_bajo'] >= $datos['umbral_optimo_min']) $errores['umbrales'] = 'El umbral Crítico debe ser menor al Óptimo.';
